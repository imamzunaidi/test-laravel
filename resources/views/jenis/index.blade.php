...
<div class="my-3 p-3 bg-body rounded shadow-sm">
    ...
    <!-- TOMBOL TAMBAH DATA -->
    <div class="pb-3">
        <a href='{{ url('jenis/create') }}' class="btn btn-primary">+ Tambah Data</a>
    </div>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->jurusan }}</td>
                <td>
                    <a href='{{ url('jenis/edit'.$item->nim.'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
